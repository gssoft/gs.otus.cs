...
namespace TradingPlatform.Services
{
    public class EventHubStrategy : EventDrivenRandomStrategy01
    {
        ...
        // Events/EventHubStrategy.cs - ОБНОВляем все обработчики событий
        //private async void OnTradeExecutedHandler(ITrade trade)
        //{
        //    if (!IsRunning()) return;
        ...
        //            trade.Price,
        //            trade.Qty,
        //            StrategyName,      // Уже есть
        //            trade.DateTime
        //        );

        //        await _eventHub.PublishAsync(tradeEvent);
        //        _logger?.LogDebug("✅ Опубликовано событие TradeExecuted: {Ticker} {Side} {Strategy}",
        //            trade.Ticker, trade.Side, StrategyName);
        //    }
        //    catch (Exception ex)
        //    {
        //        _logger?.LogError(ex, "❌ Ошибка при публикации события TradeExecuted");
        ...
        //        var positionEvent = new PositionChangedEvent(
        //            position.Ticker,
        //            StrategyName,      // ДОБАВИЛИ СТРАТЕГИЮ!
        //            position.NetQuantity,
        //            position.UnrealizedProfit,
        //            position.Status.ToString(),
        //            DateTime.Now
        ...
        //        await _eventHub.PublishAsync(positionEvent);
        //        _logger?.LogDebug("✅ Опубликовано событие PositionChanged: {Ticker} {Strategy} NetQty={NetQty}",
        //            position.Ticker, StrategyName, position.NetQuantity);
        //    }
        //    catch (Exception ex)
        //    {
        //        _logger?.LogError(ex, "❌ Ошибка при публикации события PositionChanged");
