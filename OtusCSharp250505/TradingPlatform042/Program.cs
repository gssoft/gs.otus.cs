...
// ========== РЕГИСТРАЦИЯ СТАТИЧЕСКИХ КЛЮЧЕЙ EventHub ==========
// ДОЛЖНА БЫТЬ ДО ВСЕГО ОСТАЛЬНОГО, особенно до запуска фоновых сервисов
try
{
    ...
    logger.LogInformation("🔑 Регистрация статических ключей EventHub...");
    ...
    logger.LogInformation("✅ Зарегистрировано {Count} статических ключей", registeredCount);

    // Принудительная регистрация ключей, которые использует InMemoryTradingDatabase
    // Это гарантирует, что они будут зарегистрированы ДО подписки
    ...
    logger.LogInformation("✅ Ключи для торговых событий зарегистрированы");
}
catch (Exception ex)
{
...
//{
//    var logger = app.Services.GetRequiredService<ILogger<Program>>();
//    logger.LogInformation("🚀 ТОРГОВАЯ ПЛАТФОРМА С EVENTHUB ЗАПУЩЕНА");
...
//    Console.WriteLine("\n" + new string('=', 80));
//    Console.WriteLine("🚀 ТОРГОВАЯ ПЛАТФОРМА УСПЕШНО ЗАПУЩЕНА!");
//    Console.WriteLine(new string('=', 80));
...
//        Console.WriteLine("\n📋 Основные страницы (откройте любой из адресов выше):");
...
//        // Для первого адреса показываем полные URL
//        var firstAddress = addresses.First();
//        try
//        {
//            var baseUri = new Uri(firstAddress);
//            var baseUrl = $"{baseUri.Scheme}://{baseUri.Host}:{baseUri.Port}";

//            foreach (var page in pages)
//            {
//                Console.WriteLine($"   📍 {page.Name,-10} - {baseUrl}{page.Path}");
//            }

//            Console.WriteLine($"\n⚡ Для быстрого старта откройте в браузере:");
//            Console.WriteLine($"   {baseUrl}/Finance");
//        }
//        catch
//        {
//            // Если не удалось распарсить адрес
//            foreach (var page in pages)
//            {
//                Console.WriteLine($"   📍 {page.Name,-10} - {firstAddress}{page.Path}");
//            }

//            Console.WriteLine($"\n⚡ Для быстрого старта откройте в браузере:");
//            Console.WriteLine($"   {firstAddress}/Finance");
//        }
//    }
//    else
//    {
//        // Fallback на порт 5000
//        Console.WriteLine("🌐 Приложение доступно по стандартным адресам:");
//        Console.WriteLine("   🔗 http://localhost:5000");
//        Console.WriteLine("   🔗 https://localhost:5001");

//        Console.WriteLine("\n📋 Основные страницы:");
//        Console.WriteLine("   📊 Графики - http://localhost:5000/Finance");
//        Console.WriteLine("   📈 Сводка  - http://localhost:5000/Summary");
//        Console.WriteLine("   💰 Сделки  - http://localhost:5000/Trades");
//        Console.WriteLine("   📝 Ордера  - http://localhost:5000/Orders");
//        Console.WriteLine("   🤝 Сделки  - http://localhost:5000/Deals");
//        Console.WriteLine("   📊 Позиции - http://localhost:5000/Positions");

//        Console.WriteLine("\n⚡ Для быстрого старта откройте в браузере:");
//        Console.WriteLine("   http://localhost:5000/Finance");
//    }

//    Console.WriteLine("\n⏳ Пауза 10 секунд для просмотра информации...");
//    Console.WriteLine(new string('=', 80));
...
//    Console.WriteLine($"✅ Тикеров: {tickers.Count}");
//    Console.WriteLine($"✅ Стратегий: {tickers.Sum(t => t.Strategies.Count)}");
//    Console.WriteLine($"✅ InMemoryDatabase: {summaries.Count()} summaries");
//    Console.WriteLine($"✅ SignalR Hub: /tradingDataHub");
//    Console.WriteLine(new string('=', 60) + "\n");
//});
...
//    Console.WriteLine("\n" + new string('=', 60));
//    Console.WriteLine("ТОРГОВАЯ ПЛАТФОРМА ЗАПУЩЕНА");
//    Console.WriteLine(new string('=', 60));
//    Console.WriteLine($"Тикеров: {tickers.Count}");
//    Console.WriteLine($"Стратегий: {tickers.Sum(t => t.Strategies.Count)}");
//    Console.WriteLine($"InMemoryDatabase: {summaries.Count()} summaries");
//    Console.WriteLine($"Trading Dashboard: /TradingDashboard/Index");
//    Console.WriteLine($"SignalR Hub: /tradingDataHub");
//    Console.WriteLine(new string('=', 60) + "\n");

//    //lock (consoleLock)
//    //{
//    //    Console.WriteLine("Смотрим на каких портах нас подслушивают...");
